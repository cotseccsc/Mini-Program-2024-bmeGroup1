...
# 2024.08.31
今日我们将设计好的首页加入了主项目，还优化了导航界面的样式。我们也进行了简易的急救指导设计工作，文字润色与界面美化正在进行中。同时我们加入了用户可以自由选择是否成为志愿者的功能，进一步加强了程序的可用性，拓展了其功能范围。我们还做了用户勋章获得条件的简单设计，用户做对10道题、20道题、30道题可以分别获得不同勋章。最后我们进行了紧急呼救功能的设计，UI已有，但是内部逻辑尚待改进。
